    ...
    private void toggleAvailability(final boolean status) {
        class ToggleAvailability extends AsyncTask<Void, Void, String> {
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (obj.getString("error").equals("FALSE")) {
                        Toast.makeText(getApplicationContext(), "Availability has been updated successfully", Toast.LENGTH_SHORT).show();
                    } else {
            ...
            protected String doInBackground(Void... voids) {
                ...
                params.put("uid", "" + uid);
                params.put("choice", status ? "1" : "0");
                //returing the response
                return requestHandler.sendPostRequest(Constants.URL_setAvailability, params);
...
//                    //returing the response
                    return requestHandler.sendPostRequest(Constants.URL_changePassword, params);
